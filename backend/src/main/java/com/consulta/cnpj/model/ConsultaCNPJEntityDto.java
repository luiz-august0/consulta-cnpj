...
public class ConsultaCNPJEntityDto {
    @Id
    private String cnpj;
    ...
    public ConsultaCNPJEntityDto() {
    }

    public ConsultaCNPJEntityDto(String cnpj, String razao_social, String cidade, String situacao_cadastral, LocalDate data_cadastro, String endereco, String telefone) {
        this.cnpj = cnpj;
